...
// Struct for defining Metasploit connection info
...
// Structs for session listing RPC calls
...
// Function to create new Metasploit connection object for interacting with RPC
...
// Generic function to perform sending of msgpack'd data to RPC server
...
// Perform RPC request to login to MSF RPC server and retrieve API token
...
// Perform RPC request to logout and invalidate API token
...
// Perform RPC request to retrieve current sessions in MSF instance
